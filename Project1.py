...
def show_introduction():
    ...
    intro_text1 = "Welcome to the our Color Space Project!"
...
ronrimg = cv.imread("C:/Users/nicko/Downloads/ronpic.jpg")

ronrimg = cv.resize(ronrimg, (Nickoimg.shape[1], Nickoimg.shape[0]))
...
process_and_concatenate(ronrimg, 'Other', (4 * Nickoimg.shape[1] // 5 + 10, 30), 0.5, images_stack)
